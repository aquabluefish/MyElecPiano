...
public class DeviceListActivity extends Activity implements
	...
	// 定数定義
	private final static int WC = LinearLayout.LayoutParams.WRAP_CONTENT;	//幅の最適設定
	private final static int MP = LinearLayout.LayoutParams.MATCH_PARENT;	//幅のフル設定
	public static String DEVICEADDRESS = "deviceaddress";
	private ArrayAdapter<String> DeviceList;
	private BluetoothAdapter BTadapter;

	// アクティビティ起動時に最初に実行するメソッド
	@Override
